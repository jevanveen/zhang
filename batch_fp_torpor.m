%% BATCH RUN: Plot the normalized dF/F for one or more sessions and get chart with analysis.
%
% Inputs: 
%    Follow instructions up until "BEGIN CODE" line below.
%
% MAT-files required: fp_torpor.m
%
...
figure_name = 'Photometry_sessions';
...
writetable(k, 'Photometry_sessions.xlsx', 'Sheet', 1, 'Range', 'A1', 'WriteVariableNames', true)
